...
arithmetic_expression: CONST_INT {
          ...
          | MO_SQUARE LPAREN arithmetic_expression RPAREN {
              $$ = create_expression_node(AST_NODE_ARITHMETIC_EXP, AST_MO_SQUARE, $3->value, NULL, NULL); 
          }
          | MO_EXP LPAREN arithmetic_expression RPAREN {
              $$ = create_expression_node_float(AST_NODE_ARITHMETIC_EXP, AST_MO_EXP, $3->valuef, NULL, NULL); 
          }
          | MO_SIN LPAREN arithmetic_expression RPAREN {
              $$ = create_expression_node_float(AST_NODE_ARITHMETIC_EXP, AST_MO_SIN, $3->valuef, NULL, NULL); 
          }
          | MO_COS LPAREN arithmetic_expression RPAREN {
              $$ = create_expression_node_float(AST_NODE_ARITHMETIC_EXP, AST_MO_COS, $3->valuef, NULL, NULL); 
          }
          | MO_TAN LPAREN arithmetic_expression RPAREN {
              $$ = create_expression_node_float(AST_NODE_ARITHMETIC_EXP, AST_MO_TAN, $3->valuef, NULL, NULL); 
          }
          | MO_LOG LPAREN arithmetic_expression RPAREN {
              $$ = create_expression_node_float(AST_NODE_ARITHMETIC_EXP, AST_MO_LOG, $3->valuef, NULL, NULL); 
          }
